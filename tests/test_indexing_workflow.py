...
TEMPLATE_ATTRIBUTES = [
    {"name": n, "value": os.getenv(f"DR_TEMPLATE_{n}", d)}
    for n, d in [
        ("ALIAS_LISTS", "18621"), ("ANALYTICAL_SETTINGS", "18542"),
        ("BILLING_REPORT_SETTINGS", "18629"), ("CUSTOM_FIELDS", "18626"),
        ("DOMAIN_LISTS", "18565"), ("EMAIL_SIGNATURE", "18569"),
        ("EXPORT_FIELDS", "18537"), ("EXPORT_SETTINGS", "18558"),
        ("INDEX_SETTINGS", "18514"), ("LOADFILE_SETTINGS", "18623"),
        ("SEARCH_FIELDS", "18593"), ("DOCUMENT_METADATA", "18571"),
        ("USER_EXP", "18567"), ("REPORT_SETTINGS", "18615"),
        ("SEARCH_SETTINGS", "18575"), ("DUPE_SURVIVORSHIP", "18573"),
        ("TAG", "18563"),
    ]
]
