...
# Template attribute IDs are specific to 192.168.58.128.
# Do not replace with DR_TEMPLATE_* env vars — these IDs live in the DB
# and are not portable across environments.
TEMPLATE_ATTRIBUTES = [
